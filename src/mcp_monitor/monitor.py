"""MCPSecurityMonitor - orchestrates security detectors for MCP tool calls.
...
class MCPSecurityMonitor:
    ...
    def inspect_call(self, tool_call: dict[str, Any]) -> dict[str, Any]:
        ...
        Returns dict with keys: allowed, risk_score, findings, call_id
        """
        ...
        try:
            ...
            logger.exception("Prompt injection detector failed for call %s", call_id)
            findings.append("error:injection_detector_failed")
        ...
        try:
            ...
            logger.exception("PII detector failed for call %s", call_id)
            findings.append("error:pii_detector_failed")
        ...
        try:
            ...
            logger.exception("Shadow server detector failed for call %s", call_id)
            findings.append("error:shadow_detector_failed")
        ...
        try:
            ...
            logger.exception("Exfiltration detector failed for call %s", call_id)
            findings.append("error:exfiltration_detector_failed")
    ...
    def inspect_output(self, tool_name: str, output: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception("Exfiltration detector failed for output %s", call_id)
            findings.append("error:exfiltration_detector_failed")

        # PII in output - serialize properly
        try:
            ...
            logger.exception("PII detector failed for output %s", call_id)
            findings.append("error:pii_detector_failed")

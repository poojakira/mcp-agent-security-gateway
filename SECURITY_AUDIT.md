...
The README's "Honest status" section mentions the self-test catalog score (now 37 of 37 attacks
blocked on the bundled red-team catalog after argument-inspection hardening) is a self-test "on the
bundled simulator", but there is no prominent notice
